...
class AuthForm extends StatefulWidget {
  ...
  AuthForm({this.slideInAnimation, this.slideInController});
  @override
...
class _AuthFormState extends State<AuthForm> with TickerProviderStateMixin {
  void switcherOut() async {
    await widget.slideInController.reverse();
    context.read<AuthUiProvider>().change();
    await widget.slideInController.forward(from: -1.5);
  }
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Form(
            key: Provider.of<AuthUiProvider>(context, listen: false).formKey,
            child: Column(
