...
final Color kMainBgColor = Color(0xFF10171E);
final Color kUiBgColor = Color(0xFF151A1B);
final Color kStrokeColor = Color(0XFFA5F4FF);
final Color kStrokeColor2 = Color(0XFF454F55);
final Color kMainFrameColor = Color(0xFF8C8E8D);
